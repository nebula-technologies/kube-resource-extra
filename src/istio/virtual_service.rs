...
pub struct HttpMatchRequest {
    ...
    /// Required: No
    headers: HashMap<String, StringMatch>,
    ...
    /// Required: No
    queryParams: HashMap<String, StringMatch>,
    ...
    /// Required: No
    withoutHeaders: HashMap<String, StringMatch>,
...
pub struct HttpRedirect {
    ...
    /// Required: No,
    derivePort: RedirectPortSelection,
