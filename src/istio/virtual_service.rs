...
pub struct TlsRoute {
    ...
    /// Required: Yes
    r#match: Vec<TlsMatchAttribures>,
    /// The destination to which the connection should be forwarded to.
    /// Required: No
    route: Option<Vec<RouteDestination>>,
}
...
pub struct TcpRoute {
    ...
    /// matched if any one of the match blocks succeed.
    /// Required: No
    r#match: Option<Vec<L4MatchAttributes>>,
    /// The destination to which the connection should be forwarded to.
    /// Required: No
    route: Option<Vec<RouteDestination>>,
}
...
pub struct HttpRoute {
    ...
    /// matched if any one of the match blocks succeed.
    /// Required: No
    r#match: Option<Vec<HttpMatchRequest>>,
    ...
    /// Required: No
    route: Option<Vec<HttpRouteDestination>>,
    ...
    /// Required: No
    fault: Option<HttpFaultInjection>,
...
pub struct HttpMatchRequest {
    ...
    /// Required: No
    headers: Option<HashMap<String, StringMatch>>,
    ...
    /// Required: No
    sourceLabels: Option<HashMap<String, String>>,
    ...
    /// Required: No
    withoutHeaders: Option<HashMap<String, StringMatch>>,
...
pub struct L4MatchAttributes {
    ...
    /// Required: No
    destinationSubnets: Option<Vec<String>>,
...
pub struct HttpRedirect {
    ...
    /// Required: No,
    derivePort: Option<RedirectPortSelection>,
...
pub struct CorsPolicy {
    ...
    /// Required: No
    allowOrigins: Option<Vec<StringMatch>>,
...
pub struct HttpFaultInjection {
    ...
    /// Required: No
    delay: Option<FaultInjectionDelay>,

    /// Abort Http request attempts and return error codes back to downstream service, giving the impression that the upstream service is faulty.
    /// Required: No
    abort: Option<FaultInjectionAbort>,
}
